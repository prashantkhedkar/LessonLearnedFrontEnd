...
const ObservationDetailWidget: React.FC<PageHeaderProps> = ({
 ...
 const intl = useIntl();
  ...
  const displayType = observationData?.observationTypeLookupNameAr; // This is a number, might need lookup for display
  const displayLevel = observationData?.levelLookupNameAr; 
  const combatFunction=observationData?.combatFunctionLookupNameAr; // This is a number, might need lookup for display
